# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 15:57:22 2020

@author: catcry

            
____________________________________________________________________________
            >>   Predefined Numpy loading of Sets    <<
    
    Just to load saved UNSW Sets saved numpy arrays
____________________________________________________________________________
...
Xtrain = np.load('unsw_Xtrain.npy')
Ytrain = np.load('unsw_Ytrain.npy')

Xvalid = np.load('unsw_Xvalid.npy')
Yvalid = np.load('unsw_Yvalid.npy')

Xtest = np.load('unsw_Xtest.npy')
Ytest = np.load('unsw_Ytest.npy')
